...
* **Consequences:**
  ...
  * **Negative:** Data isolation relies entirely on application-level filtering ([authMiddleware.js](file:///home/sohailtsm/M%20Tech%20Contents/SEM%20II/SE/Projects/project3/backend/src/middleware/authMiddleware.js) and strict repository queries). A bug in the query logic could expose one club's financial data to another.
...
* **Decision:** Implement a **Factory Design Pattern** ([MerchandiseFactory.js](file:///home/sohailtsm/M%20Tech%20Contents/SEM%20II/SE/Projects/project3/backend/src/patterns/factory/MerchandiseFactory.js)) to encapsulate the creation logic of merchandise. The factory accepts a product type and payload, constructs the appropriate class (`TshirtProduct`, `CapProduct`), validates the specific fields natively, and outputs a standardized document.
* **Consequences:**
...
* **Decision:** Implement an internal **Publish-Subscribe (Pub/Sub) Architecture** using a custom [EventBus](file:///home/sohailtsm/M%20Tech%20Contents/SEM%20II/SE/Projects/project3/backend/src/patterns/pubsub/EventBus.js#7-30) class and an **Observer Pattern** ([OrderEventEmitter](file:///home/sohailtsm/M%20Tech%20Contents/SEM%20II/SE/Projects/project3/backend/src/patterns/observer/OrderEventEmitter.js#7-15)). The API endpoint will instantly save the delivery slot and emit a `slot:created` event asynchronously. The [DeliverySubscribers.js](file:///home/sohailtsm/M%20Tech%20Contents/SEM%20II/SE/Projects/project3/backend/src/patterns/pubsub/DeliverySubscribers.js) module will listen in the background, run the heavy queries, and write the notifications.
* **Consequences:**
...
* **Decision:** All database interactions must be encapsulated behind **Repository Pattern** classes (e.g., [UserRepository](file:///home/sohailtsm/M%20Tech%20Contents/SEM%20II/SE/Projects/project3/backend/src/repositories/UserRepository.js#3-49), [OrderRepository](file:///home/sohailtsm/M%20Tech%20Contents/SEM%20II/SE/Projects/project3/backend/src/repositories/OrderRepository.js#3-48)). Controllers must interact with databases strictly through Repository methods like `UserRepository.findByEmail(email)`.
* **Consequences:**
